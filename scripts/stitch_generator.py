...
def get_system_font_path(language_id: int = 1) -> str:
    ...
    # Check project public/fonts folder first (Next.js project structure)
    project_root = Path(__file__).parent.parent
    project_font = project_root / "public" / "fonts" / font_name
    ...
    raise FileNotFoundError(
        f"Font '{font_name}' not found. Please place it in public/fonts/ directory.\n"
